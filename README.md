...
<p align="center">
  <a href="https://github.com/TomoSectionDivision/Tomo-Section-Division/releases"><img src="https://img.shields.io/badge/version-0.1.1-8a3030?style=flat-square" alt="0.1.1"></a>
...
```text
src-tauri/target/release/bundle/nsis/TOMO_0.1.1_x64-setup.exe
```
